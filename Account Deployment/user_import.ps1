...
function send_email {
    ...
    if ($master_config.mail_settings.send_email) {
        ...
        $email_data_body = "Howdy,<br>Your account has been created for the semester at $($master_config.mail_settings.org_name). " +
        "For security reasons, you may not be able to sign into the VPN yet. Please check Slack for more information. " +
        "For support with the VPN, please email support@leahycenter.org or call (802)-865-5457<br><br><b>Account Information:</b>" +
